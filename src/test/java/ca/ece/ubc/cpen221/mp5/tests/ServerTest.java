...
public class ServerTest {
    ...
    public void testAddReview1() throws IOException {
        ...
        client.sendRequest(
                "ADDREVIEW {\"business_id\":\"gclB3ED6uk6viWlolSb_uA\",\"user_id\":\"_NH7Cpq3qZkByP5xR4gXog\",\"text\":\"Good cafe!\",\"stars\":4}");
        ...
        /*
         * Confirm that corresponding user and restaurant in database was updated
         * correctly
         */
    ...
    public void testAddReviewEmptyText() throws IOException {
        ...
        client.sendRequest(
                "ADDREVIEW {\"business_id\":\"gclB3ED6uk6viWlolSb_uA\",\"user_id\":\"_NH7Cpq3qZkByP5xR4gXog\",\"text\":\"\",\"stars\":4}");
        String confirmReply = client.getReply();
    ...
    public void testAddReviewIncorrectRestaurant() throws IOException {
        ...
        // this business ID has characters removed from testAddReview1
        client.sendRequest(
                "ADDREVIEW {\"business_id\":\"B3ED6uk6viWlolSb_uA\",\"user_id\":\"_NH7Cpq3qZkByP5xR4gXog\",\"text\":\"Good cafe!\",\"stars\":4}");
        String confirmReply = client.getReply();
    ...
    public void testAddReviewIncorrectUser() throws IOException {
        ...
        client.sendRequest(
                "ADDREVIEW {\"business_id\":\"gclB3ED6uk6viWlolSb_uA\",\"user_id\":\"Cpq3qZkByP5xR4gXog\",\"text\":\"Good cafe!\",\"stars\":4}");
        String confirmReply = client.getReply();
